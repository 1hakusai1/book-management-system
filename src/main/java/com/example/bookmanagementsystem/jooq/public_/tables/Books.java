...
public class Books extends TableImpl<BooksRecord> {
     ...
     */
    public final TableField<BooksRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");
    ...
    public AuthorsBooksPath authorsBooks() {
        if (_authorsBooks == null)
            _authorsBooks = new AuthorsBooksPath(this, null, Keys.AUTHORS_BOOKS__AUTHORS_BOOKS_BOOK_ID_FKEY.getInverseKey());
